...
/**
 * @mixin IncomingLogicalMessageMutationContext
 */
class IncomingLogicalMessageMutationContextSpec extends ObjectBehavior
{
    private $messageMock;
    ...
    {
        $this->shouldHaveType('PSB\Core\MessageMutation\Pipeline\Incoming\IncomingLogicalMessageMutationContext');
    }
